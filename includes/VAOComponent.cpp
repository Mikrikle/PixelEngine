...
void VAOComponent::genBuffers(GLfloat* vertices, GLuint sizeV, GLuint* indices, GLuint sizeI, bool useTexture)
{
	GLuint VBO, EBO, BUFSIZE;
	if (useTexture)
		BUFSIZE = 8;
	else
		BUFSIZE = 6;
	...
	// coords
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, BUFSIZE * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
	// colors
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, BUFSIZE * sizeof(float), (void*)(3 * sizeof(float)));
